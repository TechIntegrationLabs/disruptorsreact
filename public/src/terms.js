...
useEffect(() => {
  ...
  const updateMetaTags = (data) => {
    var staticText = "Disruptors Media | Terms And Conditions"; 
    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-12">
          <h1 className="fade-in-up">Terms And Conditions</h1>
        </div>
      </div>
    </div>
  </section>
  <section className="content-pg">
    <div className="container">
      <div className="row">
        <div className="col-sm-12">
          <div className="cont">
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Disruptors Media LLC, 650 North Main Street, North Salt Lake, Utah 84054.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Disruptors Media, accessible from <a href="https://disruptorsmedia.com" rel="external nofollow noopener" target="_blank">disruptorsmedia.com</a></p>
</li>
<li>
...
<ul>
<li>By email: tyler@disruptorsmedia.com</li>
</ul>
              </div>
            </div>
          </div>
